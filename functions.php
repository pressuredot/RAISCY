...
* @since Bosa AI Robotics 1.0.0
*/
if ( !function_exists( 'bosa_ai_robotics_cart_link' ) ) {
    function bosa_ai_robotics_cart_link() {
        ?>	
...
* @since Bosa AI Robotics 1.0.0
*/
if ( !function_exists( 'bosa_ai_robotics_header_cart' ) ) {
    function bosa_ai_robotics_header_cart() {
        ?>
            <div class="header-cart">
                <div class="header-cart-block">
                    <div class="header-cart-inner">
                        <?php bosa_ai_robotics_cart_link(); ?>
...
* @since Bosa AI Robotics 1.0.0
*/
if ( !function_exists( 'bosa_ai_robotics_header_add_to_cart_fragment' ) ) {
    function bosa_ai_robotics_header_add_to_cart_fragment( $fragments ) {
        ob_start();
        bosa_ai_robotics_cart_link();
        $fragments['a.cart-contents'] = ob_get_clean();
        return $fragments;
    }
    add_filter( 'woocommerce_add_to_cart_fragments', 'bosa_ai_robotics_header_add_to_cart_fragment' );
}
...
* @since Bosa AI Robotics 1.0.0
*/
if ( !function_exists( 'bosa_ai_robotics_head_wishlist' ) ) {
    function bosa_ai_robotics_head_wishlist() {
            ...
            <div class="header-wishlist">
                <a href="<?php echo esc_url( $wishlist_url ); ?>">
                    ...
                    <span class="info-tooltip">
                        <?php esc_html_e( 'Wishlist', 'bosa-ai-robotics' ); ?>
                    </span>
                </a>
            </div>
            <?php
...
* @since Bosa AI Robotics 1.0.0
*/
if (!function_exists( 'bosa_ai_robotics_head_compare' ) ) {
    function bosa_ai_robotics_head_compare() {
        if ( function_exists( 'yith_woocompare_constructor' ) ) {
            ...
            <div class="header-compare">
                <a class="compare added" rel="nofollow" href="<?php echo esc_url( $yith_woocompare->obj->view_table_url() ); ?>">
                    ...
                    <span class="info-tooltip">
                        <?php esc_html_e( 'Compare', 'bosa-ai-robotics' ); ?>
                    </span>
                </a>
            </div>
            <?php
...
* @since Bosa AI Robotics 1.0.0
*/
if ( !function_exists( 'bosa_ai_robotics_my_account' ) ) {
    function bosa_ai_robotics_my_account() {
            ...
            <div class="header-my-account">
                <div class="header-login"> 
                    <a href="<?php echo esc_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ); ?>">
                        ...
                        <span class="info-tooltip">
                            <?php esc_html_e( 'My Account', 'bosa-ai-robotics' ); ?>
                        </span>
                    </a>
                </div>
            </div>
...
* @return array.
*/
function bosa_ai_robotics_get_pages(){
...
* @since Bosa AI Robotics 1.0.0
*/
if( !function_exists( 'bosa_ai_robotics_blog_advertisement_banner' ) ){
    function bosa_ai_robotics_blog_advertisement_banner(){
...
if ( ! function_exists( 'bosa_ai_robotics_grid_thumbnail_date' ) ) :
    /**
     * Prints HTML with meta information for the tags and comments.
     */
    function bosa_ai_robotics_grid_thumbnail_date() {
                    ...
                    comments_popup_link(
                        sprintf(
                            wp_kses(
                                ...
                                __( 'Comment<span class="screen-reader-text"> on %s</span>', 'bosa-ai-robotics' ),
                                array(
                                    'span' => array(
                                        'class' => array(),
                                    ),
...
if( !function_exists( 'bosa_get_intermediate_image_sizes' ) ){
    ...
    */
    function bosa_get_intermediate_image_sizes(){
        ...
        $data   = array(
            'full'          => esc_html__( 'Full Size', 'bosa-ai-robotics' ),
            'large'         => esc_html__( 'Large Size', 'bosa-ai-robotics' ),
            'medium'        => esc_html__( 'Medium Size', 'bosa-ai-robotics' ),
            'medium_large'  => esc_html__( 'Medium Large Size', 'bosa-ai-robotics' ),
            'thumbnail'     => esc_html__( 'Thumbnail Size', 'bosa-ai-robotics' ),
            '1536x1536'     => esc_html__( '1536x1536 Size', 'bosa-ai-robotics' ),
            '2048x2048'     => esc_html__( '2048x2048 Size', 'bosa-ai-robotics' ),
            'bosa-1920-550' => esc_html__( '1920x550 Size', 'bosa-ai-robotics' ),
            'bosa-1370-550' => esc_html__( '1370x550 Size', 'bosa-ai-robotics' ),
            'bosa-590-310'  => esc_html__( '590x310 Size', 'bosa-ai-robotics' ),
            'bosa-420-380'  => esc_html__( '420x380 Size', 'bosa-ai-robotics' ),
            'bosa-420-300'  => esc_html__( '420x300 Size', 'bosa-ai-robotics' ),
            'bosa-420-200'  => esc_html__( '420x200 Size', 'bosa-ai-robotics' ),
            'bosa-290-150'  => esc_html__( '290x150 Size', 'bosa-ai-robotics' ),
            'bosa-80-60'    => esc_html__( '80x60 Size', 'bosa-ai-robotics' ),
        );
...
if( !function_exists( 'bosa_ai_robotics_archive_post_layout_filter' ) ){
    /**
    ...
    * @return array
    */
    add_filter( 'bosa_archive_post_layout_filter', 'bosa_ai_robotics_archive_post_layout_filter' );
    function bosa_ai_robotics_archive_post_layout_filter( $post_layout ){
...
if( !function_exists( 'bosa_ai_robotics_footer_layout_filter' ) ){
    /**
    ...
    * @return array
    */
    add_filter( 'bosa_footer_layout_filter', 'bosa_ai_robotics_footer_layout_filter' );
    function bosa_ai_robotics_footer_layout_filter( $footer_layout ){
        $added_footer = array(
...
* @return array
*/
function bosa_ai_robotics_get_product_categories(){
...
if ( ! function_exists( 'bosa_ai_robotics_modify_locale' ) ) :
    /**
     ...
     * @return array
     */
    function bosa_ai_robotics_modify_locale( $locale ) {
    ...
    add_filter( 'bosa_localize_var', 'bosa_ai_robotics_modify_locale' );
endif;

if( !function_exists( 'bosa_ai_robotics_transparent_body_class' ) ){
    /**
    ...
    * @return array $class
    */
    function bosa_ai_robotics_transparent_body_class( $class ){
    ...
    add_filter( 'body_class', 'bosa_ai_robotics_transparent_body_class' );
}
