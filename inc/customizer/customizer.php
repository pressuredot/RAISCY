 ...
 */
add_action( 'customize_preview_init', 'bosa_ai_robotics_customize_preview_js', 999, 1 );

function bosa_ai_robotics_customize_preview_js() {
	wp_enqueue_script( 'bosa-ai-robotics-customizer', get_stylesheet_directory_uri() . '/inc/customizer/customizer.js', array( 'customize-preview' ) );
}

function bosa_ai_robotics_customize_getting_js() {
	wp_dequeue_script( 'bosa-customizer-getting-started' );
	wp_enqueue_script( 'bosa-ai-robotics-customizer-getting-started', get_stylesheet_directory_uri() . '/inc/getting-started/getting-started.js', array( 'customize-controls', 'jquery' ), true );

	wp_enqueue_style( 'bosa-ai-robotics-customize-controls', get_stylesheet_directory_uri() . '/inc/customizer/customizer.css' );
}
add_action( 'customize_controls_enqueue_scripts', 'bosa_ai_robotics_customize_getting_js', 99 );
 ...
 * @return void
 */
add_action( 'init' , 'bosa_ai_robotics_kirki_fields', 999, 1 );

function bosa_ai_robotics_kirki_fields(){
	...
	*/
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Site Title', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Site Description', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Main Menu', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Main Menu Description', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Body', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'General Title (H1 - H6)', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page & Single Post Title', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Title Typography', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Typography', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Meta Typography', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Excerpt Typography', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Slider Button Typography', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Content Alignment', 'bosa-ai-robotics' ),
		'type'        => 'select',
		'settings'    => 'main_slider_content_alignment',
		'section'     => 'main_slider_options',
		'default'     => 'left',
		'choices'  => array(
			'center' => esc_html__( 'Center', 'bosa-ai-robotics' ),
			'left'   => esc_html__( 'Left', 'bosa-ai-robotics' ),
			'right'  => esc_html__( 'Right', 'bosa-ai-robotics' ),
		),
		'priority'	  =>  180,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Section Title Typography', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Section Description Typography', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Title Typography', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Typography', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Typography', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Excerpt Typography', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Widget Title Typography', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Header Layouts', 'bosa-ai-robotics' ),
		'description' => esc_html__( 'Select layout & scroll below to change its options', 'bosa-ai-robotics' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Top Header Section', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Non Transparent Mid Header Background Color', 'bosa-ai-robotics' ),
		'description'  => esc_html__( 'It can be used as a transparent background color over image.', 'bosa-ai-robotics' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Non Transparent Mid Header Text Link Hover Color', 'bosa-ai-robotics' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Mid Header Section Border', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Header Height (in px)', 'bosa-ai-robotics' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Contact Details', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Phone Number', 'bosa-ai-robotics' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Header Secondary Menu', 'bosa-ai-robotics' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Footer Layouts', 'bosa-ai-robotics' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Bottom Footer Typography', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Select Image', 'bosa-ai-robotics' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Image Link', 'bosa-ai-robotics' ),
		'type'     => 'link',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Image Target', 'bosa-ai-robotics' ),
		'description' => esc_html__( 'If enabled, the page will be open in an another browser tab.', 'bosa-ai-robotics' ),
		'type'     => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Width', 'bosa-ai-robotics' ),
		'type'         => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Border', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'feature_posts_options', array(
	    'title'          => esc_html__( 'Featured Posts / Pages', 'bosa-ai-robotics' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Posts / Pages', 'bosa-ai-robotics' ),
		...
		'priority'    => '9',
		'choices'  => array(
			'featured_posts' => esc_html__( 'Featured Posts', 'bosa-ai-robotics' ),
			'featured_pages' => esc_html__( 'Featured Pages', 'bosa-ai-robotics' ),
		)
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Section', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Title', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Title', 'bosa-ai-robotics' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Description', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Description', 'bosa-ai-robotics' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Title and Description Alignment', 'bosa-ai-robotics' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Layout', 'bosa-ai-robotics' ),
		'description' => esc_html__( 'Select layout & scroll below to change its options', 'bosa-ai-robotics' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Title Color', 'bosa-ai-robotics' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Background Color', 'bosa-ai-robotics' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Color', 'bosa-ai-robotics' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Text Color', 'bosa-ai-robotics' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Icon Color', 'bosa-ai-robotics' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Hover Color', 'bosa-ai-robotics' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Columns', 'bosa-ai-robotics' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_columns',
		'section'     => 'feature_posts_options',
		'default'     => 'three_columns',
		'placeholder' => esc_attr__( 'Select category', 'bosa-ai-robotics' ),
		'choices'  => array(
			'one_column'    => esc_html__( '1 Column', 'bosa-ai-robotics' ),
			'two_columns'   => esc_html__( '2 Columns', 'bosa-ai-robotics' ),
			'three_columns' => esc_html__( '3 Columns', 'bosa-ai-robotics' ),
			'four_columns'  => esc_html__( '4 Columns', 'bosa-ai-robotics' ),
		),
		'priority'	  =>  160,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Category', 'bosa-ai-robotics' ),
		'description' => esc_html__( 'Recent posts will show if any category is not chosen.', 'bosa-ai-robotics' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_category',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select category', 'bosa-ai-robotics' ), 
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Posts Overlay Opacity', 'bosa-ai-robotics' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post View Number', 'bosa-ai-robotics' ),
		'description'  => esc_html__( 'Number of posts to show.', 'bosa-ai-robotics' ),
		'type'         => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Height (in px)', 'bosa-ai-robotics' ),
		'description'  => esc_html__( 'This option will only apply to Desktop. Please click on below Desktop Icon to see changes. Automatically adjust by theme default in the responsive devices.
		', 'bosa-ai-robotics' ),
		'type'         => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Image Size', 'bosa-ai-robotics' ),
		'type'        => 'select',
		'settings'    => 'render_feature_post_image_size',
		'section'     => 'feature_posts_options',
		'default'     => 'bosa-420-300',
		'placeholder' => esc_html__( 'Select Image Size', 'bosa-ai-robotics' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Background Image Size', 'bosa-ai-robotics' ),
		'type'         => 'radio',
		'settings'     => 'feature_posts_image_size',
		'section'      => 'feature_posts_options',
		'default'      => 'cover',
		'choices'      => array(
			'cover'    => esc_html__( 'Cover', 'bosa-ai-robotics' ),
			'pattern'  => esc_html__( 'Pattern / Repeat', 'bosa-ai-robotics' ),
			'norepeat' => esc_html__( 'No Repeat', 'bosa-ai-robotics' ),
		),
		'priority'	   =>  220,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Posts Border Radius (px)', 'bosa-ai-robotics' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Text Alignment', 'bosa-ai-robotics' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_text_alignment',
		'section'     => 'feature_posts_options',
		'default'     => 'text-left',
		'choices'     => array(
			'text-left'	 	=> esc_html__( 'Left', 'bosa-ai-robotics' ),
			'text-center'  	=> esc_html__( 'Center', 'bosa-ai-robotics' ),   
			'text-right'	=> esc_html__( 'Right', 'bosa-ai-robotics' ),
		),
		'priority'	  =>  240,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Alignment', 'bosa-ai-robotics' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_title_alignment',
		'section'     => 'feature_posts_options',
		'default'     => 'align-bottom',
		'choices'     => array(
			'align-top'	 	=> esc_html__( 'Top', 'bosa-ai-robotics' ),
			'align-center'  => esc_html__( 'Center', 'bosa-ai-robotics' ),   
			'align-bottom'  => esc_html__( 'Bottom', 'bosa-ai-robotics' ),
		),
		'priority'	  =>  250,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Title', 'bosa-ai-robotics' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Title Divider', 'bosa-ai-robotics' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Posts category', 'bosa-ai-robotics' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Date', 'bosa-ai-robotics' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Author', 'bosa-ai-robotics' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Comment', 'bosa-ai-robotics' ),
		'type'        => 'checkbox',
	...
	// featured pages
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Pages Section', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 1', 'bosa-ai-robotics' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_one',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 1', 'bosa-ai-robotics' ),
		'choices'     => bosa_ai_robotics_get_pages(),
		'priority'	  => 450,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 2', 'bosa-ai-robotics' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_two',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 2', 'bosa-ai-robotics' ),
		'choices'     => bosa_ai_robotics_get_pages(),
		'priority'	  => 460,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 3', 'bosa-ai-robotics' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_three',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'choices'     => bosa_ai_robotics_get_pages(),
		'placeholder' => esc_html__( 'Select Page 3', 'bosa-ai-robotics' ),
		'priority'	  => 470,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 4', 'bosa-ai-robotics' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_four',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'choices'     => bosa_ai_robotics_get_pages(),
		'placeholder' => esc_html__( 'Select Page 4', 'bosa-ai-robotics' ),
		'priority'	  => 480,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Page Overlay Opacity', 'bosa-ai-robotics' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Border Radius (px)', 'bosa-ai-robotics' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Page Title', 'bosa-ai-robotics' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Title Color', 'bosa-ai-robotics' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Hover Color', 'bosa-ai-robotics' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Title Horizontal Alignment', 'bosa-ai-robotics' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Title Vertical Alignment', 'bosa-ai-robotics' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Title Typography', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts / Pages', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_advert_banner_options', array(
	    'title'          => esc_html__( 'Blog Advertisement Banner', 'bosa-ai-robotics' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => '22',
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Advertisement Banner', 'bosa-ai-robotics' ),
		'description'  => esc_html__( 'Image dimensions 1230 by 100 pixels is recommended.', 'bosa-ai-robotics' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Advertisement Banner Link', 'bosa-ai-robotics' ),
		'type'     => 'link',
	...
	Kirki::add_field( 'bosa', array(
		'label'    		=> esc_html__( 'Advertisement Banner Target', 'bosa-ai-robotics' ),
		'description' 	=> esc_html__( 'If enabled, the page will be open in an another browser tab.', 'bosa-ai-robotics' ),
		'type'     		=> 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Advertisement Banner', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'feature_posts_two_options', array(
	    'title'          => esc_html__( 'Featured Posts Two', 'bosa-ai-robotics' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 24,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Two Section', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Posts Overlay Opacity', 'bosa-ai-robotics' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Horizontal Alignment', 'bosa-ai-robotics' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Vertical Alignment', 'bosa-ai-robotics' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Two', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Layouts', 'bosa-ai-robotics' ),
		'description' => esc_html__( 'Grid / List / Single/ Grid Thumbnail', 'bosa-ai-robotics' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
	    ...
	    'section'     => 'blog_page_style_options',
	    'default'     => esc_html__( 'Thumbnail Post Options', 'bosa-ai-robotics' ),
	    'priority'	  => 300,
	    'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Image Size', 'bosa-ai-robotics' ),
		'description' => esc_html__( 'Image Size for thumbnail post only.', 'bosa-ai-robotics' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Border Radius (px)', 'bosa-ai-robotics' ),
		'description' => esc_html__( 'Post Border Radius for thumbnail post only.', 'bosa-ai-robotics' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Date', 'bosa-ai-robotics' ),
		'description'  => esc_html__( 'Disables date for thumbnail post only.', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Author', 'bosa-ai-robotics' ),
		'description'  => esc_html__( 'Disables author for thumbnail post only.', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Comment Link', 'bosa-ai-robotics' ),
		'description'  => esc_html__( 'Disables comment link for thumbnail post only.', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Excerpt', 'bosa-ai-robotics' ),
		'description'  => esc_html__( 'Disables excerpt for thumbnail post only.', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Post Button', 'bosa-ai-robotics' ),
		'description'  => esc_html__( 'Disables button for thumbnail post only.', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_services', array(
	    'title'          => esc_html__( 'Services', 'bosa-ai-robotics' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 26,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Services Section', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Services', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_featured_categories', array(
	    'title'          => esc_html__( 'Featured Categories', 'bosa-ai-robotics' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 27,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Categories Section', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Category One', 'bosa-ai-robotics' ),
		'type'        => 'select',
		'settings'    => 'featured_category_one',
		'section'     => 'blog_featured_categories',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category One', 'bosa-ai-robotics' ),
		'choices'     => bosa_get_post_categories(),
		'priority'	  => 20,
	));

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category One Image', 'bosa-ai-robotics' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Category Two', 'bosa-ai-robotics' ),
		'type'        => 'select',
		'settings'    => 'featured_category_two',
		'section'     => 'blog_featured_categories',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Two', 'bosa-ai-robotics' ),
		'choices'     => bosa_get_post_categories(),
		'priority'	  => 40,
	));

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Two Image', 'bosa-ai-robotics' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Category Three', 'bosa-ai-robotics' ),
		'type'        => 'select',
		'settings'    => 'featured_category_three',
		'section'     => 'blog_featured_categories',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Three', 'bosa-ai-robotics' ),
		'choices'     => bosa_get_post_categories(),
		'priority'	  => 60,
	));

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Three Image', 'bosa-ai-robotics' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Category Four', 'bosa-ai-robotics' ),
		'type'        => 'select',
		'settings'    => 'featured_category_four',
		'section'     => 'blog_featured_categories',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Four', 'bosa-ai-robotics' ),
		'choices'     => bosa_get_post_categories(),
		'priority'	  => 80,
	));

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Four Image', 'bosa-ai-robotics' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Category Five', 'bosa-ai-robotics' ),
		'type'        => 'select',
		'settings'    => 'featured_category_five',
		'section'     => 'blog_featured_categories',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Five', 'bosa-ai-robotics' ),
		'choices'     => bosa_get_post_categories(),
		'priority'	  => 100,
	));

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Five Image', 'bosa-ai-robotics' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Categories', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	//Comments
	Kirki::add_section( 'blog_comment', array(
	    'title'          => esc_html__( 'Comments', 'bosa-ai-robotics' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 28,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Comments Section', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
		'settings'     => 'disable_comments_section',
	...
	;Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 5', 'bosa-ai-robotics' ),
		'type'        => 'select',
		'settings'    => 'comments_page_five',
		'section'     => 'blog_comment',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 5', 'bosa-ai-robotics' ),
		'choices'     => bosa_ai_robotics_get_pages(),
		'priority'	  => 50,
	) );
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 6', 'bosa-ai-robotics' ),
		'type'        => 'select',
		'settings'    => 'comments_page_six',
		'section'     => 'blog_comment',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 6', 'bosa-ai-robotics' ),
		'choices'     => bosa_ai_robotics_get_pages(),
		'priority'	  => 60,
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Comments', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
		'settings'     => 'disable_mobile_comments',
		'section'      => 'blog_page_responsive',
		'default'      => false,
		'priority'	   => 28,
		'active_callback' => array(
			array(
				'setting'  => 'disable_comments_section',
				'operator' => '==',
				'value'    => false,
			),
		),
	...
	Kirki::add_section( 'blog_coupons', array(
	    'title'          => esc_html__( 'Coupons', 'bosa-ai-robotics' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 29,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Coupons Section', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Coupon Image One', 'bosa-ai-robotics' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Coupon One', 'bosa-ai-robotics' ),
		'type'        => 'text',
		'settings'    => 'coupon_one_content',
		'section'     => 'blog_coupons',
		'default'     => '',
		'priority'	   => 30,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Coupon Image two', 'bosa-ai-robotics' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Coupon Two', 'bosa-ai-robotics' ),
		'type'        => 'text',
		'settings'    => 'coupon_two_content',
		'section'     => 'blog_coupons',
		'default'     => '',
		'priority'	   => 50,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Coupon Image Three', 'bosa-ai-robotics' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Coupon Three', 'bosa-ai-robotics' ),
		'type'        => 'text',
		'settings'    => 'coupon_three_content',
		'section'     => 'blog_coupons',
		'default'     => '',
		'priority'	   => 70,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Coupon Image Four', 'bosa-ai-robotics' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Coupon Four', 'bosa-ai-robotics' ),
		'type'        => 'text',
		'settings'    => 'coupon_four_content',
		'section'     => 'blog_coupons',
		'default'     => '',
		'priority'	   => 90,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Coupons', 'bosa-ai-robotics' ),
		'type'         => 'checkbox',
		'settings'     => 'disable_mobile_coupons',
		'section'      => 'blog_page_responsive',
		'default'      => false,
		'priority'	   => 29,
		'active_callback' => array(
	...
	// Typography
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Product Title Typography', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Product Price Typography', 'bosa-ai-robotics' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Add to Cart Button Typography', 'bosa-ai-robotics' ),
		'type'         => 'typography',
